...
public class RedisTemplateApiController {
    ...
    private int LOCK_EXPIRE = 100;


    @RequestMapping("/test")
    public String redisTest() {
//        redisTemplate.opsForValue().set("redisKey","redisValue");
//        String sn_1 = (String) redisTemplate.opsForList().rightPop("sn_1");
//        redisTemplate.opsForList().leftPush("sn_1", "data1");
        HashMap<String, String> map = new HashMap<>();
        map.put("sn_1", "data1");
        map.put("sn_2", "data2");
        redisTemplate.opsForHash().putAll("waitUpdate", map);
        HashMap<String, String> rs = (HashMap) redisTemplate.opsForHash().entries("waitUpdate");
        return "done";
    }
